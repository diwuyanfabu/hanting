...
public class Orders {
	...
	public Orders(String orderID, Integer userID, Integer serviceID, Integer resouroeID, Integer orderType,
			...
			String remarks, Date scheduledStartTime, Date scheduledEndTime, Integer population, Integer number,
			Float smallPlan, Float totalPrice, String uploadPath, Double weight, Integer integral, Integer collectGoods,
