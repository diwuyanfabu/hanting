...
public class ServiceType {
	...
	private Integer stclass;//服务类型级数(1是一级服务 以此类推)
	...
	public ServiceType(Integer stid, Integer stPid, String stName, Integer stclass, Integer sort, Boolean display,
			Integer operationTime, Integer confirmTime, Integer violatedNumber, Integer proportion, Boolean toExamine,
	...
	public ServiceType(Integer stPid, String stName, Integer stclass, Integer sort, Boolean display,
			Integer operationTime, Integer confirmTime, Integer violatedNumber, Integer proportion, Boolean toExamine,
			String advertisement) {
		super();
		this.stPid = stPid;
